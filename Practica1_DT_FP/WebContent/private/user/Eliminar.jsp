...
<body>
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Eliminar Pedidos</h1>
            <!-- Icon Divider-->
        </div>
    </header>
    ...
    <section>
        <div class="form">
            <div class="datos">
                <form id="formulario01" method="POST" action="/Practica1_DT_FP/EliminarPedido">
                    <label>Codigo Cabecera a Eliminar</label><br><br>

...
<body>
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Modificar Pedidos</h1>
            <!-- Icon Divider-->
        </div>
    </header>
    ...
    <section>
        <div class="form">
            <div class="datos">
                <form id="formulario01" method="POST" action="/Practica1_DT_FP/ModificarPedidos">
                    <label>Codigo Cabecera a Modificar</label><br><br>
                    <input type="text" id="idcab" name="idcab" value="" placeholder="Ingrese el Codigo de Cabecera..." />
                    <br><br>
                    <label>Codigo Detalle a Modificar</label><br><br>
                    <input type="text" id="iddet" name="iddet" value="" placeholder="Ingrese el Codigo del Detalle..." />
                    <br><br>
                    <label>Codigo de Producto</label><br><br>
                    <input type="text" id="idpro" name="idpro" value="" placeholder="Ingrese el Codigo del Producto ..." />
                    <!-- Lista de opciones -->
                    <datalist id="idpro">
	                    <c:forEach var="pro" items="${empresa.producto}">
	                    	<option value="${pro.productoId}">${pro.productoNombre}</option>
	                    </c:forEach>  
                    </datalist><br><br>
                    <br><br>
                    <label>Cantidad de Compra del Producto</label><br><br>
                    <input type="text" id="cant" name="cant" value="" placeholder="Ingrese la cantidad de compra del Producto ..." />
                    <br><br>
